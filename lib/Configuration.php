...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-v2.fattureincloud.it';
     ...
     * @var string
     */
    protected $userAgent = 'FattureInCloud/2.0.16/PHP-SDK';
    ...
    {
        $report  = 'PHP SDK (FattureInCloud) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.20' . PHP_EOL;
