...
class IssuedDocumentExtraData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'debt_vat_detect' => 'debt_vat_detect',
        'revenue_detect' => 'revenue_detect'
    ];
    ...
    protected static $setters = [
        ...
        'debt_vat_detect' => 'setDebtVatDetect',
        'revenue_detect' => 'setRevenueDetect'
    ];
    ...
    protected static $getters = [
        ...
        'debt_vat_detect' => 'getDebtVatDetect',
        'revenue_detect' => 'getRevenueDetect'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('debt_vat_detect', $data ?? [], null);
        $this->setIfExists('revenue_detect', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets debt_vat_detect
     *
     * @return bool|null
     */
    public function getDebtVatDetect()
    {
        return $this->container['debt_vat_detect'];
    }

    /**
     * Sets debt_vat_detect
     *
     * @param bool|null $debt_vat_detect Issued document debt VAT detect
     *
     * @return self
     */
    public function setDebtVatDetect($debt_vat_detect)
    {
        if (is_null($debt_vat_detect)) {
            array_push($this->openAPINullablesSetToNull, 'debt_vat_detect');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('debt_vat_detect', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['debt_vat_detect'] = $debt_vat_detect;
     ...
     * @return bool|null
     */
    public function getRevenueDetect()
    {
        return $this->container['revenue_detect'];
    }

    /**
     * Sets revenue_detect
     *
     * @param bool|null $revenue_detect Issued document revenue detect
     *
     * @return self
     */
    public function setRevenueDetect($revenue_detect)
    {
        if (is_null($revenue_detect)) {
            array_push($this->openAPINullablesSetToNull, 'revenue_detect');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('revenue_detect', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['revenue_detect'] = $revenue_detect;
