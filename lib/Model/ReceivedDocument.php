...
class ReceivedDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'created_at' => null,
        'updated_at' => null,
        'ei_reception_date' => null,
        'is_from_pending_expenses' => null
    ];
    ...
    protected static $setters = [
        ...
        'ei_reception_date' => 'setEiReceptionDate',
        'is_from_pending_expenses' => 'setIsFromPendingExpenses'
    ];
    ...
    protected static $getters = [
        ...
        'ei_reception_date' => 'getEiReceptionDate',
        'is_from_pending_expenses' => 'getIsFromPendingExpenses'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ei_reception_date', $data ?? [], null);
        $this->setIfExists('is_from_pending_expenses', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets ei_reception_date
     *
     * @return string|null
     */
    public function getEiReceptionDate()
    {
        return $this->container['ei_reception_date'];
    }

    /**
     * Sets ei_reception_date
     *
     * @param string|null $ei_reception_date [Read Only] Received document e-invoice reception date, needs fic_view  fieldset
     *
     * @return self
     */
    public function setEiReceptionDate($ei_reception_date)
    {
        if (is_null($ei_reception_date)) {
            array_push($this->openAPINullablesSetToNull, 'ei_reception_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ei_reception_date', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ei_reception_date'] = $ei_reception_date;

        return $this;
    }

    /**
     * Gets is_from_pending_expenses
     *
     * @return bool|null
     */
    public function getIsFromPendingExpenses()
    {
        return $this->container['is_from_pending_expenses'];
    }

    /**
     * Sets is_from_pending_expenses
     *
     * @param bool|null $is_from_pending_expenses [Read Only] True if received document is generated from pending expenses,  needs fic_view fieldset
     *
     * @return self
     */
    public function setIsFromPendingExpenses($is_from_pending_expenses)
    {
        if (is_null($is_from_pending_expenses)) {
            array_push($this->openAPINullablesSetToNull, 'is_from_pending_expenses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_from_pending_expenses', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_from_pending_expenses'] = $is_from_pending_expenses;
