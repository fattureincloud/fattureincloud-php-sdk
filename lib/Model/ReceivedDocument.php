...
class ReceivedDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items_list' => '\FattureInCloud\Model\ReceivedDocumentItemsList[]',
        'payments_list' => '\FattureInCloud\Model\ReceivedDocumentPaymentsList[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tax_deductibility']) && ($this->container['tax_deductibility'] > 100)) {
            $invalidProperties[] = "invalid value for 'tax_deductibility', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['tax_deductibility']) && ($this->container['tax_deductibility'] < 0)) {
            $invalidProperties[] = "invalid value for 'tax_deductibility', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['vat_deductibility']) && ($this->container['vat_deductibility'] > 100)) {
            $invalidProperties[] = "invalid value for 'vat_deductibility', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['vat_deductibility']) && ($this->container['vat_deductibility'] < 0)) {
            $invalidProperties[] = "invalid value for 'vat_deductibility', must be bigger than or equal to 0.";
        }
     ...
     * Gets entity
     *
     * @return \FattureInCloud\Model\ReceivedDocumentEntity
     */
     ...
     * Sets entity
     *
     * @param \FattureInCloud\Model\ReceivedDocumentEntity $entity entity
     *
     * @return self
     */
    ...
    public function setTaxDeductibility($tax_deductibility)
    {
        ...
        if (!is_null($tax_deductibility) && ($tax_deductibility > 100)) {
            throw new \InvalidArgumentException('invalid value for $tax_deductibility when calling ReceivedDocument., must be smaller than or equal to 100.');
        }
        if (!is_null($tax_deductibility) && ($tax_deductibility < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_deductibility when calling ReceivedDocument., must be bigger than or equal to 0.');
        }
    ...
    public function setVatDeductibility($vat_deductibility)
    {
        ...
        if (!is_null($vat_deductibility) && ($vat_deductibility > 100)) {
            throw new \InvalidArgumentException('invalid value for $vat_deductibility when calling ReceivedDocument., must be smaller than or equal to 100.');
        }
        if (!is_null($vat_deductibility) && ($vat_deductibility < 0)) {
            throw new \InvalidArgumentException('invalid value for $vat_deductibility when calling ReceivedDocument., must be bigger than or equal to 0.');
        }
     ...
     * Gets items_list
     *
     * @return \FattureInCloud\Model\ReceivedDocumentItemsList[]|null
     */
     ...
     * Sets items_list
     *
     * @param \FattureInCloud\Model\ReceivedDocumentItemsList[]|null $items_list items_list
     *
     * @return self
     */
     ...
     * Gets payments_list
     *
     * @return \FattureInCloud\Model\ReceivedDocumentPaymentsList[]|null
     */
     ...
     * Sets payments_list
     *
     * @param \FattureInCloud\Model\ReceivedDocumentPaymentsList[]|null $payments_list payments_list
     *
     * @return self
     */
