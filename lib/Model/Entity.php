...
class Entity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'intent_declaration_protocol_number' => '\DateTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_intent_declaration'] = $data['has_intent_declaration'] ?? null;
        $this->container['intent_declaration_protocol_number'] = $data['intent_declaration_protocol_number'] ?? null;
        $this->container['intent_declaration_protocol_date'] = $data['intent_declaration_protocol_date'] ?? null;
     ...
     * Sets address_street
     *
     * @param string|null $address_street Street address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $address_postal_code Postal code.
     *
     * @return self
     */
     ...
     * Sets address_city
     *
     * @param string|null $address_city City.
     *
     * @return self
     */
     ...
     *
     * @param string|null $address_province Province.
     *
     * @return self
     */
     ...
     * Sets address_extra
     *
     * @param string|null $address_extra Address extra info.
     *
     * @return self
     */
     ...
     *
     * @param string|null $certified_email Certified email.
     *
     * @return self
     */
     ...
     *
     * @param int|null $default_payment_terms [Only for client] Default payment terms.
     *
     * @return self
     */
    ...
    /**
     * Sets default_payment_terms_type, the accepted values are available in \FattureInCloud\Model\DefaultPaymentTermsType
     *
     ...
     * Sets bank_name
     *
     * @param string|null $bank_name [Only for client] Bank name.
     *
     * @return self
     */
     ...
     * Sets bank_iban
     *
     * @param string|null $bank_iban [Only for client] Iban.
     *
     * @return self
     */
     ...
     *
     * @param string|null $bank_swift_code [Only for client] Bank swift code.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_address [Only for client] Shipping address.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $intent_declaration_protocol_number [Only for client] Intent declaration protocol number.
     *
     * @return self
     */
     ...
     *
     * @param string|null $intent_declaration_protocol_date [Only for client] Intent declaration protocol date.
     *
     * @return self
     */
