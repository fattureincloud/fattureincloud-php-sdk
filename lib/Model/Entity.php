...
class Entity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets country_iso
     *
     * @param string|null $country_iso Country Iso
     *
     * @return self
     */
     ...
     *
     * @param string|null $intent_declaration_protocol_number [Only for client] Intent declaration protocol number.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $intent_declaration_protocol_date [Only for client] Intent declaration protocol date.
     *
     * @return self
     */
