...
class F24 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets attachment_url
     *
     * @param string|null $attachment_url [Temporary] [Read Only] Absolute url of the attached file. Authomatically set if a valid attachment token is passed via POST /taxes or PUT /taxes/{documentId}.
     *
     * @return self
     */
