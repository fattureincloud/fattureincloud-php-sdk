...
class CompanyInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fic_plan_name' => '\FattureInCloud\Model\FattureInCloudPlanType',
    ...
    public function __construct($data = null)
    {
        ...
        $this->setIfExists('fic_plan_name', $data ?? [], null);
    ...
    /**
     * Sets fic_plan_name, the accepted values are available in \FattureInCloud\Model\FattureInCloudPlanType
     *
     * @param string|null $fic_plan_name fic_plan_name
     *
     * @return self
     */
    public function setFicPlanName($fic_plan_name)
    {
        if (is_null($fic_plan_name)) {
            throw new \InvalidArgumentException('non-nullable fic_plan_name cannot be null');
        }
