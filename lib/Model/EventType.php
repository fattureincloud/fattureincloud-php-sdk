...
class EventType
{
    ...
    public const RECEIVED_DOCUMENTS_E_INVOICES_STATUS_UPDATE = 'it.fattureincloud.webhooks.received_documents.e_invoices.status_update';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::RECEIVED_DOCUMENTS_E_INVOICES_STATUS_UPDATE
        ];
    }
}
