...
/**
 * VerifyWebhooksSubscription Class Doc Comment
 *
 * @category Class
 * @package  FattureInCloud
 * @author   Fatture In Cloud API team
 ...
 */
class VerifyWebhooksSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifyWebhooksSubscription';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'verification_method' => '\FattureInCloud\Model\WebhooksSubscriptionVerificationMethod'
    ];
    ...
    */
    ...
    /**
     * Sets verification_method, the accepted values are available in \FattureInCloud\Model\WebhooksSubscriptionVerificationMethod
     *
