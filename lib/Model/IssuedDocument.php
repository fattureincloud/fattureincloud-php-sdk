...
class IssuedDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const SHOW_TOTALS_NONE = 'none';
    const SHOW_TOTALS_NETS = 'nets';
    const SHOW_TOTALS_ALL = 'all';
     ...
     * @return string[]
     */
    public function getShowTotalsAllowableValues()
    {
        return [
            self::SHOW_TOTALS_NONE,
            self::SHOW_TOTALS_NETS,
            self::SHOW_TOTALS_ALL,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['show_totals'] = $data['show_totals'] ?? 'all';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getShowTotalsAllowableValues();
        if (!is_null($this->container['show_totals']) && !in_array($this->container['show_totals'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'show_totals', must be one of '%s'",
                $this->container['show_totals'],
     ...
     * Sets show_totals
     *
     * @param string|null $show_totals Totals mode.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getShowTotalsAllowableValues();
        if (!is_null($show_totals) && !in_array($show_totals, $allowedValues, true)) {
