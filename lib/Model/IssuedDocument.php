...
class IssuedDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cassa_taxable']) && ($this->container['cassa_taxable'] > 100)) {
            $invalidProperties[] = "invalid value for 'cassa_taxable', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['cassa_taxable']) && ($this->container['cassa_taxable'] < 0)) {
            $invalidProperties[] = "invalid value for 'cassa_taxable', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['cassa2']) && ($this->container['cassa2'] > 100)) {
            $invalidProperties[] = "invalid value for 'cassa2', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['cassa2']) && ($this->container['cassa2'] < 0)) {
            $invalidProperties[] = "invalid value for 'cassa2', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['cassa2_taxable']) && ($this->container['cassa2_taxable'] > 100)) {
            $invalidProperties[] = "invalid value for 'cassa2_taxable', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['cassa2_taxable']) && ($this->container['cassa2_taxable'] < 0)) {
            $invalidProperties[] = "invalid value for 'cassa2_taxable', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['global_cassa_taxable']) && ($this->container['global_cassa_taxable'] > 100)) {
            $invalidProperties[] = "invalid value for 'global_cassa_taxable', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['global_cassa_taxable']) && ($this->container['global_cassa_taxable'] < 0)) {
            $invalidProperties[] = "invalid value for 'global_cassa_taxable', must be bigger than or equal to 0.";
        }
    ...
    public function setCassaTaxable($cassa_taxable)
    {
        ...
        if (!is_null($cassa_taxable) && ($cassa_taxable > 100)) {
            throw new \InvalidArgumentException('invalid value for $cassa_taxable when calling IssuedDocument., must be smaller than or equal to 100.');
        }
        if (!is_null($cassa_taxable) && ($cassa_taxable < 0)) {
            throw new \InvalidArgumentException('invalid value for $cassa_taxable when calling IssuedDocument., must be bigger than or equal to 0.');
        }
    ...
    public function setCassa2($cassa2)
    {
        ...
        if (!is_null($cassa2) && ($cassa2 > 100)) {
            throw new \InvalidArgumentException('invalid value for $cassa2 when calling IssuedDocument., must be smaller than or equal to 100.');
        }
        if (!is_null($cassa2) && ($cassa2 < 0)) {
            throw new \InvalidArgumentException('invalid value for $cassa2 when calling IssuedDocument., must be bigger than or equal to 0.');
        }
    ...
    public function setCassa2Taxable($cassa2_taxable)
    {
        ...
        if (!is_null($cassa2_taxable) && ($cassa2_taxable > 100)) {
            throw new \InvalidArgumentException('invalid value for $cassa2_taxable when calling IssuedDocument., must be smaller than or equal to 100.');
        }
        if (!is_null($cassa2_taxable) && ($cassa2_taxable < 0)) {
            throw new \InvalidArgumentException('invalid value for $cassa2_taxable when calling IssuedDocument., must be bigger than or equal to 0.');
        }
    ...
    public function setGlobalCassaTaxable($global_cassa_taxable)
    {
        ...
        if (!is_null($global_cassa_taxable) && ($global_cassa_taxable > 100)) {
            throw new \InvalidArgumentException('invalid value for $global_cassa_taxable when calling IssuedDocument., must be smaller than or equal to 100.');
        }
        if (!is_null($global_cassa_taxable) && ($global_cassa_taxable < 0)) {
            throw new \InvalidArgumentException('invalid value for $global_cassa_taxable when calling IssuedDocument., must be bigger than or equal to 0.');
        }
     ...
     * Sets ei_cassa_type
     *
     * @param string|null $ei_cassa_type Einvoice cassa type
     *
     * @return self
     */
     ...
     * Sets ei_cassa2_type
     *
     * @param string|null $ei_cassa2_type Einvoice cassa2 type
     *
     * @return self
     */
     ...
     *
     * @param string|null $ei_withholding_tax_causal Einvoice withholding tax causal
     *
     * @return self
     */
     ...
     *
     * @param string|null $ei_other_withholding_tax_type Einvoice other withholding tax type
     *
     * @return self
     */
     ...
     *
     * @param string|null $ei_other_withholding_tax_causal Einvoice other withholding tax causal
     *
     * @return self
     */
