...
class IssuedDocumentItemsListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setDiscount($discount)
    {
        ...
        if (!is_null($discount) && ($discount > 100)) {
            throw new \InvalidArgumentException('invalid value for $discount when calling IssuedDocumentItemsListItem., must be smaller than or equal to 100.');
        }
        if (!is_null($discount) && ($discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $discount when calling IssuedDocumentItemsListItem., must be bigger than or equal to 0.');
        }
