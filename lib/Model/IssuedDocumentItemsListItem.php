...
class IssuedDocumentItemsListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['not_taxable'] = $data['not_taxable'] ?? null;
        $this->container['apply_withholding_taxes'] = $data['apply_withholding_taxes'] ?? null;
        $this->container['discount'] = $data['discount'] ?? null;
        $this->container['discount_highlight'] = $data['discount_highlight'] ?? null;
        $this->container['in_ddt'] = $data['in_ddt'] ?? null;
