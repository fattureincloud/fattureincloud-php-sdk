...
class GetUserInfoResponseInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['need_marketing_consents_confirmation'] = $data['need_marketing_consents_confirmation'] ?? null;
        $this->container['need_password_change'] = $data['need_password_change'] ?? null;
        $this->container['need_terms_of_service_confirmation'] = $data['need_terms_of_service_confirmation'] ?? null;
    }
