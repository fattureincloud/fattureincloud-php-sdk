...
class Client implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \DateTime|null $intent_declaration_protocol_number Intent declaration protocol number.
     *
     * @return self
     */
     ...
     *
     * @param string|null $intent_declaration_protocol_date Intent declaration protocol date.
     *
     * @return self
     */
