...
class ArchiveApi
{
     ...
     */
    public function listArchiveDocuments($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        list($response) = $this->listArchiveDocumentsWithHttpInfo($company_id, $fields, $fieldset, $sort, $page, $per_page, $q);
        return $response;
    }
     ...
     */
    public function listArchiveDocumentsWithHttpInfo($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        $request = $this->listArchiveDocumentsRequest($company_id, $fields, $fieldset, $sort, $page, $per_page, $q);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listArchiveDocumentsAsync($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        return $this->listArchiveDocumentsAsyncWithHttpInfo($company_id, $fields, $fieldset, $sort, $page, $per_page, $q)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listArchiveDocumentsAsyncWithHttpInfo($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        $returnType = '\FattureInCloud\Model\ListArchiveDocumentsResponse';
        $request = $this->listArchiveDocumentsRequest($company_id, $fields, $fieldset, $sort, $page, $per_page, $q);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listArchiveDocumentsRequest($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
