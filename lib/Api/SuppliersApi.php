...
class SuppliersApi
{
     ...
     */
    public function listSuppliers($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        list($response) = $this->listSuppliersWithHttpInfo($company_id, $fields, $fieldset, $sort, $page, $per_page, $q);
        return $response;
    }
     ...
     */
    public function listSuppliersWithHttpInfo($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        $request = $this->listSuppliersRequest($company_id, $fields, $fieldset, $sort, $page, $per_page, $q);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSuppliersAsync($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        return $this->listSuppliersAsyncWithHttpInfo($company_id, $fields, $fieldset, $sort, $page, $per_page, $q)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSuppliersAsyncWithHttpInfo($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        $returnType = '\FattureInCloud\Model\ListSuppliersResponse';
        $request = $this->listSuppliersRequest($company_id, $fields, $fieldset, $sort, $page, $per_page, $q);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listSuppliersRequest($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
