...
class WebhooksApi
{
     ...
     * @param  \FattureInCloud\Model\CreateWebhooksSubscriptionRequest|null $create_webhooks_subscription_request  (optional)
     ...
     * @return \FattureInCloud\Model\CreateWebhooksSubscriptionResponse|array<string,mixed>
     */
     ...
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FattureInCloud\Model\CreateWebhooksSubscriptionResponse|array<string,mixed>, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FattureInCloud\Model\GetWebhooksSubscriptionResponse|array<string,mixed>
     */
     ...
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FattureInCloud\Model\GetWebhooksSubscriptionResponse|array<string,mixed>, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FattureInCloud\Model\ListWebhooksSubscriptionsResponse|array<string,mixed>
     */
     ...
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FattureInCloud\Model\ListWebhooksSubscriptionsResponse|array<string,mixed>, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  int $company_id The ID of the company. (required)
     * @param  string $subscription_id The ID of the subscription. (required)
     * @param  \FattureInCloud\Model\ModifyWebhooksSubscriptionRequest|null $modify_webhooks_subscription_request modify_webhooks_subscription_request (optional)
     ...
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FattureInCloud\Model\ModifyWebhooksSubscriptionResponse|array<string,mixed>
     */
     ...
     * @param  int $company_id The ID of the company. (required)
     * @param  string $subscription_id The ID of the subscription. (required)
     * @param  \FattureInCloud\Model\ModifyWebhooksSubscriptionRequest|null $modify_webhooks_subscription_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['modifyWebhooksSubscription'] to see the possible values for this operation
     *
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FattureInCloud\Model\ModifyWebhooksSubscriptionResponse|array<string,mixed>, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation verifyWebhooksSubscription
     *
     * Verify Webhooks Subscription
     *
     * @param  int $company_id The ID of the company. (required)
     * @param  string $subscription_id The ID of the subscription. (required)
     * @param  \FattureInCloud\Model\VerifyWebhooksSubscriptionRequest|null $verify_webhooks_subscription_request verify_webhooks_subscription_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyWebhooksSubscription'] to see the possible values for this operation
     *
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function verifyWebhooksSubscription($company_id, $subscription_id, $verify_webhooks_subscription_request = null, string $contentType = self::contentTypes['verifyWebhooksSubscription'][0])
    {
        $this->verifyWebhooksSubscriptionWithHttpInfo($company_id, $subscription_id, $verify_webhooks_subscription_request, $contentType);
    }

    /**
     * Operation verifyWebhooksSubscriptionWithHttpInfo
     *
     * Verify Webhooks Subscription
     *
     * @param  int $company_id The ID of the company. (required)
     * @param  string $subscription_id The ID of the subscription. (required)
     * @param  \FattureInCloud\Model\VerifyWebhooksSubscriptionRequest|null $verify_webhooks_subscription_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyWebhooksSubscription'] to see the possible values for this operation
     *
     * @throws \FattureInCloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function verifyWebhooksSubscriptionWithHttpInfo($company_id, $subscription_id, $verify_webhooks_subscription_request = null, string $contentType = self::contentTypes['verifyWebhooksSubscription'][0])
    {
        $request = $this->verifyWebhooksSubscriptionRequest($company_id, $subscription_id, $verify_webhooks_subscription_request, $contentType);
    ...
    /**
     * Operation verifyWebhooksSubscriptionAsync
     *
     * Verify Webhooks Subscription
     *
     * @param  int $company_id The ID of the company. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function verifyWebhooksSubscriptionAsync($company_id, $subscription_id, $verify_webhooks_subscription_request = null, string $contentType = self::contentTypes['verifyWebhooksSubscription'][0])
    {
        return $this->verifyWebhooksSubscriptionAsyncWithHttpInfo($company_id, $subscription_id, $verify_webhooks_subscription_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation verifyWebhooksSubscriptionAsyncWithHttpInfo
     *
     * Verify Webhooks Subscription
     *
     * @param  int $company_id The ID of the company. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function verifyWebhooksSubscriptionAsyncWithHttpInfo($company_id, $subscription_id, $verify_webhooks_subscription_request = null, string $contentType = self::contentTypes['verifyWebhooksSubscription'][0])
    {
        $returnType = '';
        $request = $this->verifyWebhooksSubscriptionRequest($company_id, $subscription_id, $verify_webhooks_subscription_request, $contentType);
    ...
    /**
     * Create request for operation 'verifyWebhooksSubscription'
     *
     * @param  int $company_id The ID of the company. (required)
     * @param  string $subscription_id The ID of the subscription. (required)
     * @param  \FattureInCloud\Model\VerifyWebhooksSubscriptionRequest|null $verify_webhooks_subscription_request (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function verifyWebhooksSubscriptionRequest($company_id, $subscription_id, $verify_webhooks_subscription_request = null, string $contentType = self::contentTypes['verifyWebhooksSubscription'][0])
    {

        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_id when calling verifyWebhooksSubscription'
            );
        }
        ...
        if ($subscription_id === null || (is_array($subscription_id) && count($subscription_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscription_id when calling verifyWebhooksSubscription'
            );
        }



        $resourcePath = '/c/{company_id}/subscriptions/{subscription_id}/verify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($verify_webhooks_subscription_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($verify_webhooks_subscription_request));
            } else {
                $httpBody = $verify_webhooks_subscription_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
