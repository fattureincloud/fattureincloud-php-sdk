...
class IssuedDocumentsApi
{
     ...
     *
     * @param  int $company_id The Referred Company Id. (required)
     * @param  int $document_id Unique Id of the document (required)
     *
     * @throws \FattureInCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $company_id The Referred Company Id. (required)
     * @param  string $type Issued Document Type (required)
     *
     * @throws \FattureInCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function listIssuedDocuments($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        list($response) = $this->listIssuedDocumentsWithHttpInfo($company_id, $type, $fields, $fieldset, $sort, $page, $per_page);
        return $response;
    }
     ...
     */
    public function listIssuedDocumentsWithHttpInfo($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        $request = $this->listIssuedDocumentsRequest($company_id, $type, $fields, $fieldset, $sort, $page, $per_page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIssuedDocumentsAsync($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        return $this->listIssuedDocumentsAsyncWithHttpInfo($company_id, $type, $fields, $fieldset, $sort, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIssuedDocumentsAsyncWithHttpInfo($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        $returnType = '\FattureInCloud\Model\ListIssuedDocumentsResponse';
        $request = $this->listIssuedDocumentsRequest($company_id, $type, $fields, $fieldset, $sort, $page, $per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIssuedDocumentsRequest($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
