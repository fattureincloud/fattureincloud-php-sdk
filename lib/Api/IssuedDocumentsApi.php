...
class IssuedDocumentsApi
{
     ...
     * @param  string $parameter Type of the parameters to be joined (optional)
     ...
     */
    public function joinIssuedDocuments($company_id, $ids, $group = null, $parameter = null, string $contentType = self::contentTypes['joinIssuedDocuments'][0])
    {
        list($response) = $this->joinIssuedDocumentsWithHttpInfo($company_id, $ids, $group, $parameter, $contentType);
        return $response;
    }
     ...
     */
    public function joinIssuedDocumentsWithHttpInfo($company_id, $ids, $group = null, $parameter = null, string $contentType = self::contentTypes['joinIssuedDocuments'][0])
    {
        $request = $this->joinIssuedDocumentsRequest($company_id, $ids, $group, $parameter, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function joinIssuedDocumentsAsync($company_id, $ids, $group = null, $parameter = null, string $contentType = self::contentTypes['joinIssuedDocuments'][0])
    {
        return $this->joinIssuedDocumentsAsyncWithHttpInfo($company_id, $ids, $group, $parameter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function joinIssuedDocumentsAsyncWithHttpInfo($company_id, $ids, $group = null, $parameter = null, string $contentType = self::contentTypes['joinIssuedDocuments'][0])
    {
        $returnType = '\FattureInCloud\Model\JoinIssuedDocumentsResponse';
        $request = $this->joinIssuedDocumentsRequest($company_id, $ids, $group, $parameter, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function joinIssuedDocumentsRequest($company_id, $ids, $group = null, $parameter = null, string $contentType = self::contentTypes['joinIssuedDocuments'][0])
    {
     ...
     * @param  string $parameter Old document type. (optional)
     ...
     */
    public function transformIssuedDocument($company_id, $original_document_id, $new_type, $parameter = null, $e_invoice = null, $transform_keep_copy = null, string $contentType = self::contentTypes['transformIssuedDocument'][0])
    {
        list($response) = $this->transformIssuedDocumentWithHttpInfo($company_id, $original_document_id, $new_type, $parameter, $e_invoice, $transform_keep_copy, $contentType);
        return $response;
    }
     ...
     */
    public function transformIssuedDocumentWithHttpInfo($company_id, $original_document_id, $new_type, $parameter = null, $e_invoice = null, $transform_keep_copy = null, string $contentType = self::contentTypes['transformIssuedDocument'][0])
    {
        $request = $this->transformIssuedDocumentRequest($company_id, $original_document_id, $new_type, $parameter, $e_invoice, $transform_keep_copy, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transformIssuedDocumentAsync($company_id, $original_document_id, $new_type, $parameter = null, $e_invoice = null, $transform_keep_copy = null, string $contentType = self::contentTypes['transformIssuedDocument'][0])
    {
        return $this->transformIssuedDocumentAsyncWithHttpInfo($company_id, $original_document_id, $new_type, $parameter, $e_invoice, $transform_keep_copy, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transformIssuedDocumentAsyncWithHttpInfo($company_id, $original_document_id, $new_type, $parameter = null, $e_invoice = null, $transform_keep_copy = null, string $contentType = self::contentTypes['transformIssuedDocument'][0])
    {
        $returnType = '\FattureInCloud\Model\TransformIssuedDocumentResponse';
        $request = $this->transformIssuedDocumentRequest($company_id, $original_document_id, $new_type, $parameter, $e_invoice, $transform_keep_copy, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function transformIssuedDocumentRequest($company_id, $original_document_id, $new_type, $parameter = null, $e_invoice = null, $transform_keep_copy = null, string $contentType = self::contentTypes['transformIssuedDocument'][0])
    {
