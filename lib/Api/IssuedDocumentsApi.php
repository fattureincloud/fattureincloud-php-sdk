...
/**
     ...
     */
    public function listIssuedDocuments($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null, string $contentType = self::contentTypes['listIssuedDocuments'][0])
    {
        list($response) = $this->listIssuedDocumentsWithHttpInfo($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q, $contentType);
        return $response;
    }
     ...
     */
    public function listIssuedDocumentsWithHttpInfo($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null, string $contentType = self::contentTypes['listIssuedDocuments'][0])
    {
        $request = $this->listIssuedDocumentsRequest($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIssuedDocumentsAsync($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null, string $contentType = self::contentTypes['listIssuedDocuments'][0])
    {
        return $this->listIssuedDocumentsAsyncWithHttpInfo($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIssuedDocumentsAsyncWithHttpInfo($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null, string $contentType = self::contentTypes['listIssuedDocuments'][0])
    {
        $returnType = '\FattureInCloud\Model\ListIssuedDocumentsResponse';
        $request = $this->listIssuedDocumentsRequest($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIssuedDocumentsRequest($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null, string $contentType = self::contentTypes['listIssuedDocuments'][0])
    {
     ...
     *
     * @param  int $company_id The ID of the company. (required)
     * @param  string $original_document_id Original document id. (required)
