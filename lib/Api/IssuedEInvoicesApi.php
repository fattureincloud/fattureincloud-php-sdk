...
class IssuedEInvoicesApi
{
     ...
     */
    public function getEInvoiceRejectionReason($company_id, $document_id)
    {
        list($response) = $this->getEInvoiceRejectionReasonWithHttpInfo($company_id, $document_id);
        return $response;
    }
     ...
     */
    public function getEInvoiceRejectionReasonWithHttpInfo($company_id, $document_id)
    {
        $request = $this->getEInvoiceRejectionReasonRequest($company_id, $document_id);
     ...
     */
    public function getEInvoiceRejectionReasonAsync($company_id, $document_id)
    {
        return $this->getEInvoiceRejectionReasonAsyncWithHttpInfo($company_id, $document_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEInvoiceRejectionReasonAsyncWithHttpInfo($company_id, $document_id)
    {
        $returnType = '\FattureInCloud\Model\GetEInvoiceRejectionReasonResponse';
        $request = $this->getEInvoiceRejectionReasonRequest($company_id, $document_id);
     ...
     */
    public function getEInvoiceRejectionReasonRequest($company_id, $document_id)
    {
     ...
     * @return string
     */
    public function getEInvoiceXml($company_id, $document_id, $include_attachment = null)
    {
        list($response) = $this->getEInvoiceXmlWithHttpInfo($company_id, $document_id, $include_attachment);
        return $response;
    }
     ...
     */
    public function getEInvoiceXmlWithHttpInfo($company_id, $document_id, $include_attachment = null)
    {
        $request = $this->getEInvoiceXmlRequest($company_id, $document_id, $include_attachment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEInvoiceXmlAsync($company_id, $document_id, $include_attachment = null)
    {
        return $this->getEInvoiceXmlAsyncWithHttpInfo($company_id, $document_id, $include_attachment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEInvoiceXmlAsyncWithHttpInfo($company_id, $document_id, $include_attachment = null)
    {
        $returnType = 'string';
        $request = $this->getEInvoiceXmlRequest($company_id, $document_id, $include_attachment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEInvoiceXmlRequest($company_id, $document_id, $include_attachment = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($include_attachment !== null) {
            if('form' === 'form' && is_array($include_attachment)) {
                foreach($include_attachment as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['include_attachment'] = $include_attachment;
            }
        }
