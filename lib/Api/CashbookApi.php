...
class CashbookApi
{
     ...
     */
    public function createCashbookEntry($company_id, $create_cashbook_entry_request = null)
    {
        list($response) = $this->createCashbookEntryWithHttpInfo($company_id, $create_cashbook_entry_request);
        return $response;
    }
     ...
     */
    public function createCashbookEntryWithHttpInfo($company_id, $create_cashbook_entry_request = null)
    {
        $request = $this->createCashbookEntryRequest($company_id, $create_cashbook_entry_request);
     ...
     */
    public function createCashbookEntryAsync($company_id, $create_cashbook_entry_request = null)
    {
        return $this->createCashbookEntryAsyncWithHttpInfo($company_id, $create_cashbook_entry_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCashbookEntryAsyncWithHttpInfo($company_id, $create_cashbook_entry_request = null)
    {
        $returnType = '\FattureInCloud\Model\CreateCashbookEntryResponse';
        $request = $this->createCashbookEntryRequest($company_id, $create_cashbook_entry_request);
     ...
     */
    public function createCashbookEntryRequest($company_id, $create_cashbook_entry_request = null)
    {
     ...
     * @return void
     */
    public function deleteCashbookEntry($company_id, $document_id)
    {
        $this->deleteCashbookEntryWithHttpInfo($company_id, $document_id);
    }
     ...
     */
    public function deleteCashbookEntryWithHttpInfo($company_id, $document_id)
    {
        $request = $this->deleteCashbookEntryRequest($company_id, $document_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCashbookEntryAsync($company_id, $document_id)
    {
        return $this->deleteCashbookEntryAsyncWithHttpInfo($company_id, $document_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCashbookEntryAsyncWithHttpInfo($company_id, $document_id)
    {
        $returnType = '';
        $request = $this->deleteCashbookEntryRequest($company_id, $document_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteCashbookEntryRequest($company_id, $document_id)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getCashbookEntry($company_id, $document_id, $fields = null, $fieldset = null)
    {
        list($response) = $this->getCashbookEntryWithHttpInfo($company_id, $document_id, $fields, $fieldset);
        return $response;
    }
     ...
     */
    public function getCashbookEntryWithHttpInfo($company_id, $document_id, $fields = null, $fieldset = null)
    {
        $request = $this->getCashbookEntryRequest($company_id, $document_id, $fields, $fieldset);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCashbookEntryAsync($company_id, $document_id, $fields = null, $fieldset = null)
    {
        return $this->getCashbookEntryAsyncWithHttpInfo($company_id, $document_id, $fields, $fieldset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCashbookEntryAsyncWithHttpInfo($company_id, $document_id, $fields = null, $fieldset = null)
    {
        $returnType = '\FattureInCloud\Model\GetCashbookEntryResponse';
        $request = $this->getCashbookEntryRequest($company_id, $document_id, $fields, $fieldset);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCashbookEntryRequest($company_id, $document_id, $fields = null, $fieldset = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function listCashbookEntries($company_id, $date_from, $date_to, $year = null, $type = null, $payment_account_id = null)
    {
        list($response) = $this->listCashbookEntriesWithHttpInfo($company_id, $date_from, $date_to, $year, $type, $payment_account_id);
        return $response;
    }
     ...
     */
    public function listCashbookEntriesWithHttpInfo($company_id, $date_from, $date_to, $year = null, $type = null, $payment_account_id = null)
    {
        $request = $this->listCashbookEntriesRequest($company_id, $date_from, $date_to, $year, $type, $payment_account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCashbookEntriesAsync($company_id, $date_from, $date_to, $year = null, $type = null, $payment_account_id = null)
    {
        return $this->listCashbookEntriesAsyncWithHttpInfo($company_id, $date_from, $date_to, $year, $type, $payment_account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCashbookEntriesAsyncWithHttpInfo($company_id, $date_from, $date_to, $year = null, $type = null, $payment_account_id = null)
    {
        $returnType = '\FattureInCloud\Model\ListCashbookEntriesResponse';
        $request = $this->listCashbookEntriesRequest($company_id, $date_from, $date_to, $year, $type, $payment_account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCashbookEntriesRequest($company_id, $date_from, $date_to, $year = null, $type = null, $payment_account_id = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($payment_account_id !== null) {
            if('form' === 'form' && is_array($payment_account_id)) {
                foreach($payment_account_id as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['payment_account_id'] = $payment_account_id;
            }
        }
     ...
     */
    public function modifyCashbookEntry($company_id, $document_id, $modify_cashbook_entry_request = null)
    {
        list($response) = $this->modifyCashbookEntryWithHttpInfo($company_id, $document_id, $modify_cashbook_entry_request);
        return $response;
    }
     ...
     */
    public function modifyCashbookEntryWithHttpInfo($company_id, $document_id, $modify_cashbook_entry_request = null)
    {
        $request = $this->modifyCashbookEntryRequest($company_id, $document_id, $modify_cashbook_entry_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function modifyCashbookEntryAsync($company_id, $document_id, $modify_cashbook_entry_request = null)
    {
        return $this->modifyCashbookEntryAsyncWithHttpInfo($company_id, $document_id, $modify_cashbook_entry_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function modifyCashbookEntryAsyncWithHttpInfo($company_id, $document_id, $modify_cashbook_entry_request = null)
    {
        $returnType = '\FattureInCloud\Model\ModifyCashbookEntryResponse';
        $request = $this->modifyCashbookEntryRequest($company_id, $document_id, $modify_cashbook_entry_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function modifyCashbookEntryRequest($company_id, $document_id, $modify_cashbook_entry_request = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
