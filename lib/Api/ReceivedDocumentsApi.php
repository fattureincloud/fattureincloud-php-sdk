...
class ReceivedDocumentsApi
{
     ...
     */
    public function listReceivedDocuments($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        list($response) = $this->listReceivedDocumentsWithHttpInfo($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q);
        return $response;
    }
     ...
     */
    public function listReceivedDocumentsWithHttpInfo($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        $request = $this->listReceivedDocumentsRequest($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReceivedDocumentsAsync($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        return $this->listReceivedDocumentsAsyncWithHttpInfo($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReceivedDocumentsAsyncWithHttpInfo($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        $returnType = '\FattureInCloud\Model\ListReceivedDocumentsResponse';
        $request = $this->listReceivedDocumentsRequest($company_id, $type, $fields, $fieldset, $sort, $page, $per_page, $q);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listReceivedDocumentsRequest($company_id, $type, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5, $q = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
