...
class TaxesApi
{
     ...
     */
    public function listF24($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        list($response) = $this->listF24WithHttpInfo($company_id, $fields, $fieldset, $sort, $page, $per_page);
        return $response;
    }
     ...
     */
    public function listF24WithHttpInfo($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        $request = $this->listF24Request($company_id, $fields, $fieldset, $sort, $page, $per_page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listF24Async($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        return $this->listF24AsyncWithHttpInfo($company_id, $fields, $fieldset, $sort, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listF24AsyncWithHttpInfo($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        $returnType = '\FattureInCloud\Model\ListF24Response';
        $request = $this->listF24Request($company_id, $fields, $fieldset, $sort, $page, $per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listF24Request($company_id, $fields = null, $fieldset = null, $sort = null, $page = 1, $per_page = 5)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
