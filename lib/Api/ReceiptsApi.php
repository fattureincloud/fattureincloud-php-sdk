...
class ReceiptsApi
{
     ...
     */
    public function listReceipts($company_id, $fields = null, $fieldset = null, $page = 1, $per_page = 5, $sort = null, $q = null)
    {
        list($response) = $this->listReceiptsWithHttpInfo($company_id, $fields, $fieldset, $page, $per_page, $sort, $q);
        return $response;
    }
     ...
     */
    public function listReceiptsWithHttpInfo($company_id, $fields = null, $fieldset = null, $page = 1, $per_page = 5, $sort = null, $q = null)
    {
        $request = $this->listReceiptsRequest($company_id, $fields, $fieldset, $page, $per_page, $sort, $q);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReceiptsAsync($company_id, $fields = null, $fieldset = null, $page = 1, $per_page = 5, $sort = null, $q = null)
    {
        return $this->listReceiptsAsyncWithHttpInfo($company_id, $fields, $fieldset, $page, $per_page, $sort, $q)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReceiptsAsyncWithHttpInfo($company_id, $fields = null, $fieldset = null, $page = 1, $per_page = 5, $sort = null, $q = null)
    {
        $returnType = '\FattureInCloud\Model\ListReceiptsResponse';
        $request = $this->listReceiptsRequest($company_id, $fields, $fieldset, $page, $per_page, $sort, $q);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listReceiptsRequest($company_id, $fields = null, $fieldset = null, $page = 1, $per_page = 5, $sort = null, $q = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
