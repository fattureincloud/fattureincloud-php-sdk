...
class ListUserCompaniesResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(\FattureInCloud\Model\ListUserCompaniesResponse::class, $this->object);
    }
    ...
    {
        $this->assertInstanceOf(\FattureInCloud\Model\ListUserCompaniesResponseData::class, $this->object->getData());
    }
}
