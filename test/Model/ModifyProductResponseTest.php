...
class ModifyProductResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(\FattureInCloud\Model\ModifyProductResponse::class, $this->object);
    }
    ...
    {
        $this->assertInstanceOf(\FattureInCloud\Model\Product::class, $this->object->getData());
    }
}
