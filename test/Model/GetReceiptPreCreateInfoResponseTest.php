...
class GetReceiptPreCreateInfoResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\FattureInCloud\Model\GetReceiptPreCreateInfoResponse', $this->object);
    }
    ...
    {
        $this->assertInstanceOf('\FattureInCloud\Model\ReceiptPreCreateInfo', $this->object->getData());
    }
}
