<?php
/**
 * ReceivedDocumentPaymentsListTest
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ReceivedDocumentPaymentsListTest Class Doc Comment
 *
 * @category    Class
 * @description ReceivedDocumentPaymentsList
 * @package     FattureInCloud
 * @author   Fatture In Cloud API team
 * @link     https://fattureincloud.it
 */
class ReceivedDocumentPaymentsListTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->object = ObjectSerializer::deserialize($json, '\FattureInCloud\Model\ReceivedDocumentPaymentsList');
    }
    ...
    {
        TestCase::assertEquals($this->object['due_date'], $this->array['due_date']);
    }
    ...
    {
        TestCase::assertEquals($this->object['paid_date'], $this->array['paid_date']);
    }
