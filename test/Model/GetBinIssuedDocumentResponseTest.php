...
/**
 * GetBinIssuedDocumentResponseTest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetBinIssuedDocumentResponseTest Class Doc Comment
 *
 * @category    Class
 * @description GetBinIssuedDocumentResponse
 * @package     FattureInCloud
 * @author   Fatture In Cloud API team
 * @link     https://fattureincloud.it
 */
class GetBinIssuedDocumentResponseTest extends TestCase
{
    public $array = [];
    public $object;
    ...
    public function setUp(): void
    {
        ...
        $this->object = ObjectSerializer::deserialize($json, '\FattureInCloud\Model\GetBinIssuedDocumentResponse');
    }
